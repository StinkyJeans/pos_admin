...
import { RefreshCcw, Trash } from "griddy-icons";

export function DeleteHistoryModal({ open, onClose, inactiveProducts, onRestoreClick, onDeletePermanent }) {
  useEffect(() => {
    if (!open) return;
        ...
        <div className="flex items-center justify-between border-b border-stone-200 px-6 py-4">
          <div>
            ...
            <p className="mt-0.5 text-sm text-stone-500">
              Restore a product, or permanently delete it from the system.
            </p>
          </div>
          <button
            type="button"
